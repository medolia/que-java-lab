...
CREATE DATABASE if not exists secondkill_db;
use secondkill_db;
...
CREATE TABLE `order_info` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10868 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=10846 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
